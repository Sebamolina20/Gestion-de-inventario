...
public boolean agregarProducto(producto p) {
    try {
        if (!serieConNombreExiste(p.getNombre(), p.getSerie())) {
            dao.insertarProducto(p);
            System.out.println("Producto agregado exitosamente");
            return true;
        } else {
            return false; // Ya existe un producto con el mismo nombre y serie
        }
    } catch (Exception e) {
    ...
    try {
        if (serieConNombreExiste(p.getNombre(), p.getSerie())) {
            return false; // Ya existe un producto con ese nombre y serie
        } else {
    ...
    public boolean serieConNombreExiste(String nombre, String serie) {
